...
def set_abandon_cat_to_zero(original_filename="npc_profiles.csv", input_filename="normalised_npc_probabilities.csv", output_filename="final_npc_probabilities.csv"):
