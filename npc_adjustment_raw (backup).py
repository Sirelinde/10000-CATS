...
def adjust_probabilities(npc):
    ...
    if npc.get("Owns a cat") == "Yes":
        action_probabilities["Abandon cat"] += 0.10
        ...
        if npc.get("New cat owner (1 year or less)") == "Yes":
            action_probabilities["Abandon cat"] += 0.50
    ...
    # Adjustments based on whether they are well-informed on animal welfare
    ...
    if npc.get("Monthly income above 30,000 HKD") == "Above":
        action_probabilities["Adoption approval"] += 0.10
